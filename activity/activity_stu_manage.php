									...
									<td class="text-center">
										<div class="form-check form-check-inline">
											<div class="custom-control custom-radio">
												...
												<label class="custom-control-label" for="status1_<?=$result["stu_id"]?>">เข้าร่วม</label>
											</div>
										</div>
										<div class="form-check form-check-inline">
											<div class="custom-control custom-radio">
												...
												<label class="custom-control-label" for="status2_<?=$result["stu_id"]?>">ไม่เข้าร่วม</label>
											</div>
										</div>
									</td>
								</tr>
